...
import { fetchCourseManagement, sendCourseInstructorInvitation } from '../lib/api'
...
export function CourseDetailPage({ token }: { token: string }) {
  ...
  const { course, instructors, instructor_invitations, manageable_organizations, permissions, stats } = data
